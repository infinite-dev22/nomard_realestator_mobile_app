...
import 'package:real_estate_property/authentication/presentation/pages/sign_in/presentation/widget/forgot_password_layout.dart';
...
class ForgotPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const ForgotPasswordLayout(),
    );
  }
}
