...
import 'package:real_estate_property/authentication/presentation/pages/sign_in/presentation/widget/reset_password_layout.dart';
...
class ResetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const ResetPasswordLayout(),
    );
  }
}
